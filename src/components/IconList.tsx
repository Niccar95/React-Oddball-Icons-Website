...
const iconComponents = [
  ...
  { component: CalendarAlt, name: "CalendarAlt" },
  { component: CheckMark, name: "CheckMark" },
  { component: CheckMarkAlt, name: "CheckMarkAlt" },
  { component: Clock, name: "Clock" },
  { component: ClockAlt, name: "ClockAlt" },
  { component: CoffeeMug, name: "CoffeeMug" },
  { component: CoffeeMugAlt, name: "CoffeeMugAlt" },
  { component: Cross, name: "Cross" },
  { component: CrossAlt, name: "CrossAlt" },
  ...
  { component: HomeAlt, name: "HomeAlt" },
  { component: LightBulb, name: "LightBulb" },
  { component: LightBulbAlt, name: "LightBulbAlt" },
